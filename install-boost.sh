...
# issue [boost\_1\_70\_0.tar.gz is Forbidden · Issue #299 · boostorg/boost](https://github.com/boostorg/boost/issues/299)
# download_url="https://dl.bintray.com/boostorg/release/${boost_version}/source/${boost_tarball}"
download_url="https://nchc.dl.sourceforge.net/project/boost/boost/${boost_version}/${boost_tarball}"
#boost_tarball_sha256sum_1_75_0='953db31e016db7bb207f11432bef7df100516eeb746843fa0486a222e3fd49cb  boost_1_75_0.tar.bz2'
boost_tarball_sha256sum_1_68_0='7f6130bc3cf65f56a618888ce9d5ea704fa10b462be126ad053e80e553d6d8b7  boost_1_68_0.tar.bz2'
# boost_tarball_sha256sum="${boost_tarball_sha256sum=${boost_tarball_sha256sum_1_75_0}}"
boost_tarball_sha256sum="${boost_tarball_sha256sum=${boost_tarball_sha256sum_1_68_0}}"
